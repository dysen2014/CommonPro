...
public class AlphaTabView extends View {
    ...
    public void setIconNormal(TypedArray a, int id) {
        BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(id);
        mIconNormal = drawable.getBitmap();
    }
    public void setIconSelected(TypedArray a, int id) {
        BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(id);
        mIconSelected = drawable.getBitmap();
    }
