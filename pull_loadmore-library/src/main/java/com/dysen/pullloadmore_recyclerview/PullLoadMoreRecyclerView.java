...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(com.dysen.pullloadmore_recyclerview.R.layout.pull_loadmore_layout, null);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(com.dysen.pullloadmore_recyclerview.R.id.swipeRefreshLayout);
        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_green_dark, android.R.color.holo_blue_dark, android.R.color.holo_orange_dark);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayoutOnRefresh(this));

        mRecyclerView = (RecyclerView) view.findViewById(com.dysen.pullloadmore_recyclerview.R.id.recycler_view);
     ...
     * 0--HORIZONTAL
     */
    public void setLinearLayout(int orientationIndex) {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(mContext);
        linearLayoutManager.setOrientation(orientationIndex);
        mRecyclerView.setLayoutManager(linearLayoutManager);
    }
    ...
    public void setStaggeredGridLayout(int spanCount, int ori) {
        StaggeredGridLayoutManager staggeredGridLayoutManager =
                new StaggeredGridLayoutManager(spanCount, ori);
        mRecyclerView.setLayoutManager(staggeredGridLayoutManager);
    }
